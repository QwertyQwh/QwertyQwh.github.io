...
export default function Blog_AnimPianist(){
    ...
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoWalk} type="video/mp4"/></video></p>
    ...
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoCreep} type="video/mp4"/></video></p>
    <p> 对了，偶尔它还要跳一跳。 </p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoBounce} type="video/mp4"/></video></p>
    <p> 有几个场景做起来还是蛮好玩的。比如这个打雷。 </p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videov2} type="video/mp4"/></video></p>
    <p> 再比如这个气球。 </p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoPop} type="video/mp4"/></video></p>
    ...
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={video36} type="video/mp4"/></video></p>
    <p> 这个头盔的材质我还是满意的。 </p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoHelmet} type="video/mp4"/></video></p>
    <p> 最后的几个场景花去的时间反倒最多——史莱姆小人一个个排动作很烦。 </p>
    
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={video180} type="video/mp4"/></video></p>
    <p> 天天盘坐在床头桌前，工时的最大头还是等渲染看效果。做几个版本对比，可怜的GTX就要干加倍的活。 </p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoWhite} type="video/mp4"/></video></p>
    <p className="video"><video autoPlay={true} muted loop={true} playsInline = {true}><source src={videoBlack} type="video/mp4"/></video></p>
